...
export class CombatService {
  ...
  executeAction(
    ...
    switch (action.actionType) {
      case 'attack':
        ...
        log = `${playerId} attacks! Damage: ${damage}`;
      ...
      case 'skill':
        ...
        log = `${playerId} uses skill! Damage: ${damage}`;
      ...
      case 'heal':
        ...
        log = `${playerId} heals! Restored ${healed} HP`;
        break;
    }
  ...
  private endCombat(
    ...
    const totalDamage = combat.log.filter(l => l.includes('Damage')).length;
